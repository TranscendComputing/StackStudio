...
define([
        ...
        'text!templates/google/compute/googleInstanceAppTemplate.html',
        '/js/google/models/compute/googleInstance.js',
        '/js/google/collections/compute/googleInstances.js',
        '/js/google/views/compute/googleInstanceCreateView.js',
