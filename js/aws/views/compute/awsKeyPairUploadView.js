...
define([
        ...
        'backbone',
        'views/dialogView',
        'text!templates/aws/compute/awsKeyPairImportTemplate.html',
    ...
    var AwsKeyPairImportView = DialogView.extend({
        ...
        importKey: function(e) {
            ...
            if(!issue){
                ...
                $.ajax({
                    url: Common.apiUrl + "/stackstudio/v1/cloud_management/aws/compute/key_pairs/import?cred_id=" + this.credentialId + "&region=" + this.region,
