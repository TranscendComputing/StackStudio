...
define([
    ...
    var RelationalDatabase = Backbone.Model.extend({
        ...
        create: function(options, credentialId) {
            var url = Common.apiUrl + "/stackstudio/v1/cloud_management/aws/rds/databases/create?_method=PUT&cred_id=" + credentialId;
            this.sendPostAction(url, options);
        },
        
        destroy: function(credentialId) {
            var url = Common.apiUrl + "/stackstudio/v1/cloud_management/aws/rds/databases/delete?_method=DELETE&cred_id=" + credentialId;
