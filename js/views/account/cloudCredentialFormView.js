...
define([
	...
	var CloudCredentialFormView = Backbone.View.extend({
		...
		render: function() {
			...
			$("#p12_upload").attr("action", Common.apiUrl + "/identity/v1/accounts/" + Common.account.id + "/" + this.model.attributes.id + "/upload_key_pairs");
		...
		uploadFile: function(e) {
			var upUrl = Common.apiUrl + "/identity/v1/accounts/" + Common.account.id + "/" + this.model.attributes.id + "/upload_key_pairs?_method=POST";
