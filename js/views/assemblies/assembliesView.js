...
define(
    ...
    function(Common, DesignView, RuntimeView, ConfigListView,
             DockerConfigListView, Assemblies, Assembly, Template) {
        ...
        var AssembliesView = Backbone.View.extend({
          ...
          changeMode: function(mode) {
            ...
            if (mode === "prod") {
              this.tabView = new RuntimeView({
                el: '#assemblyWork',
                listView: this.listView
              });
            } else if (mode === "dev") {
              this.tabView = new DesignView({
                el: '#assemblyWork',
