...
define([
        ...
        'topstack/collections/autoscale/topstackAutoscaleGroups',
        'topstack/views/autoscale/topstackAutoscaleGroupUpdateView',
    ...
    var TopStackAutoscaleAppView = ResourceAppView.extend({
        ...
        template: _.template(topstackAutoscaleAppTemplate),
    ...
    return TopStackAutoscaleAppView;
});
