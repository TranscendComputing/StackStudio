...
define([
        ...
        'text!templates/topstack/cache/topstackCacheClusterAppTemplate.html',
        '/js/topstack/models/cache/topstackCacheCluster.js',
        '/js/topstack/collections/cache/topstackCacheClusters.js',
        ...
        'spinner',
        'jquery.dataTables'
], function( $, _, Backbone, ResourceAppView, cacheClusterAppTemplate, CacheCluster, CacheClusters, MetricStatistics, emptyGraph, ich, Common, Morris, Spinner) {
    'use strict';

    var TopStackClustersAppView = ResourceAppView.extend({
        ...
        performAction: function(event) {
            ...
            case "Modify Node Count":
                if(cluster.attributes.status === "available"){
    ...
    return TopStackClustersAppView;
});
