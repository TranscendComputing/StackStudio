...
define([
        ...
        'backbone',
        'views/dialogView',
        'text!templates/topstack/load_balancer/topstackManageAvailabilityZonesTemplate.html',
        'common'
        
], function( $, _, Backbone, DialogView, manageAvailabilityZones, Common ) {
