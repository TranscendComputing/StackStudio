...
define([
        ...
        'text!templates/topstack/load_balancer/topstackLoadBalancerAppTemplate.html',
        '/js/topstack/models/load_balancer/topstackLoadBalancer.js',
        '/js/topstack/collections/load_balancer/topstackLoadBalancers.js',
        '/js/topstack/collections/load_balancer/topstackListeners.js',
        ...
        'spinner',
        'jquery.dataTables'
], function( $, _, Backbone, ResourceAppView, ResourceRowView, loadBalancerAppTemplate, LoadBalancer, LoadBalancers, Listeners, 
    MetricStatistics, emptyGraph, ich, Common, Morris, Spinner ) {
    'use strict';

    var TopStackLoadBalancersAppView = ResourceAppView.extend({
        ...
        addInstance: function() {
            var loadBalancer = this.collection.get(this.selectedId);
            var RegisterInstancesView = this.RegisterInstancesView;
            var registerInstances = new RegisterInstancesView({cred_id: this.credentialId, region: this.region, load_balancer: loadBalancer});
            registerInstances.render();
        },
        ...
        manageAvailabilityZones: function() {
            var loadBalancer = this.collection.get(this.selectedId);
            var ManageAvailabilityZonesView = this.ManageAvailabilityZonesView;
            var manageAvailabilityZones = new ManageAvailabilityZonesView({cred_id: this.credentialId, region: this.region, load_balancer: loadBalancer});
            manageAvailabilityZones.render();
        },
    ...
    return TopStackLoadBalancersAppView;
});
