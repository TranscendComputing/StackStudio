...
define([
        ...
        'text!templates/topstack/rds/topstackRelationalDatabaseAppTemplate.html',
        '/js/topstack/models/rds/topstackRelationalDatabase.js',
        '/js/topstack/collections/rds/topstackRelationalDatabases.js',
    ...
    var TopStackRdsAppView = ResourceAppView.extend({
