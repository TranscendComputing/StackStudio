...
define([
        ...
        'text!templates/openstack/load_balancer/openstackLoadBalancerAppTemplate.html',
        '/js/openstack/models/load_balancer/openstackLoadBalancer.js',
        '/js/openstack/collections/load_balancer/openstackLoadBalancers.js',
        ...
        '/js/openstack/collections/load_balancer/openstackListeners.js',
    ...
    var OpenstackLoadBalancersAppView = ResourceAppView.extend({
    ...
    return OpenstackLoadBalancersAppView;
});
