...
define([
        ...
        'backbone',
        'views/dialogView',
        'text!templates/openstack/load_balancer/openstackLoadBalancerCreateTemplate.html',
        ...
        'jquery.dataTables'
], function( $, _, Backbone, DialogView, loadBalancerCreateTemplate, LoadBalancer, AvailabilityZones, Common ) {
