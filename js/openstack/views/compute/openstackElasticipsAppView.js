...
define([
        ...
        'openstack/collections/compute/openstackElasticIPs',
        'openstack/views/compute/openstackElasticIPsCreateView',
        'openstack/views/compute/openstackElasticIPAssociateView',
        'icanhaz',
        'common',
        'jquery.dataTables'
