...
define([
        ...
        'text!templates/openstack/autoscale/openstackAutoscaleAppTemplate.html',
        '/js/openstack/models/autoscale/openstackAutoscaleGroup.js',
        '/js/openstack/collections/autoscale/openstackAutoscaleGroups.js',
        ...
        'morris',
        'spinner'
], function( $, _, Backbone, ResourceAppView, ResourceRowView, openstackAutoscaleAppTemplate, AutoscaleGroup, AutoscaleGroups, AutoscaleGroupCreate, MetricStatistics, emptyGraph, ich, Common, Morris, Spinner ) {
    'use strict';

    var openstackAutoscaleAppView = ResourceAppView.extend({

        template: _.template(openstackAutoscaleAppTemplate),
