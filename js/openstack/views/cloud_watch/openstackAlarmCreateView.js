...
define([
        ...
        'backbone',
        'views/dialogView',
        'text!templates/openstack/cloud_watch/openstackAlarmCreateTemplate.html',
        '/js/openstack/models/cloud_watch/openstackAlarm.js',
        '/js/openstack/collections/cloud_watch/openstackMetrics.js',
        'common',
        'jquery.ui.selectmenu'
        
], function( $, _, Backbone, DialogView, alarmCreateTemplate, Alarm, Metrics, Common ) {
    
    var OpenstackAlarmCreateView = DialogView.extend({
    ...
    return OpenstackAlarmCreateView;
});
