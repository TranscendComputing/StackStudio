...
define([
    ...
    var SecurityGroup = Backbone.Model.extend({
        ...
        create: function(options, credentialId) {
            var url = Common.apiUrl + "/stackstudio/v1/cloud_management/openstack/compute/security_groups/create?_method=PUT&cred_id=" + credentialId;
            this.sendPostAction(url, options);
        },
        
        destroy: function(credentialId) {
            var url = Common.apiUrl + "/stackstudio/v1/cloud_management/openstack/compute/security_groups/delete?_method=DELETE&cred_id=" + credentialId;
