...
public class SSH2Preferences {
    ...
    final static String[][] macs = {
        ...
        { "hmac-sha256-96@ssh.com", "HmacSHA256" }
    };

    public final static String FIPS_KEX_ALGORITHMS = "diffie-hellman-group1-sha1";
    ...
    public final static String FIPS_MACS = "hmac-sha1,hmac-sha256@ssh.com";

    public final static String DEFAULT_CIPHERS_UNLIMITED_STRENGTH = 
    ...
    public final static String DEFAULT_CIPHERS_LIMITED_STRENGTH = 
    ...
    public final static String DEFAULT_HMAC = 
	"hmac-sha1,hmac-md5,hmac-sha256@ssh.com,hmac-sha1-96,hmac-md5-96";
    ...
    static {
        ...
        String cipheralgs = Crypto.hasUnlimitedStrengthJCE() ? 
            DEFAULT_CIPHERS_UNLIMITED_STRENGTH :
            DEFAULT_CIPHERS_LIMITED_STRENGTH;        
        ...
        defaultProperties.put(MACS_C2S, DEFAULT_HMAC);
        defaultProperties.put(MACS_S2C, DEFAULT_HMAC);
    ...
    public SSH2Preferences(boolean fipsmode) {
        if (fipsmode) {
            ...
            defaultProperties.put(CIPHERS_S2C, 
                                  Crypto.hasUnlimitedStrengthJCE() ? FIPS_CIPHERS : FIPS_CIPHERS_LIMITED);
            defaultProperties.put(MACS_C2S, FIPS_MACS);
            defaultProperties.put(MACS_S2C, FIPS_MACS);
        }
    ...
    public String getPreference(String type) {
        if (Crypto.isFipsMode()) {
            ...
            if (type.equals(MACS_C2S)) return FIPS_MACS;
            if (type.equals(MACS_S2C)) return FIPS_MACS;
        }  
    ...
    public static int getMacKeyLen(String macName) {
        ...
        if(macName != null) {
            ...
            if (macName.indexOf("sha") != -1 || macName.indexOf("ripemd160") != -1) 
                len = 20;
        }
        return len;
    }
