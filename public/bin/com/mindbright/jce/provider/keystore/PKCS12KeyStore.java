...
public class PKCS12KeyStore extends KeyStoreSpi {
    ...
    throws UnrecoverableKeyException {
        ...
        try {
            ...
            if (isrsakey) {
                ...
                KeyFactory keyFact = Crypto.getKeyFactory("RSA");
    ...
    private static byte[] deriveKey(char[] password, int keyLen, byte[] salt,
        ...
        try {
            MessageDigest digest = Crypto.getMessageDigest(digAlg);
    ...
    throws NoSuchAlgorithmException {
        try {
            ...
            Cipher cipher = Crypto.getCipher(cipherType);
            ...
            cipher.init(mode, new SecretKeySpec(key, Crypto.getKeyName(cipher)),
