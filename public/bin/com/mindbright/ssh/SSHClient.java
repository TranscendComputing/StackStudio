...
import com.mindbright.jce.provider.publickey.RSAAlgorithm;
...
public class SSHClient extends SSH implements NIOCallback {
    ...
    void receiveServerData(SSHPduInputStream pdu) throws IOException {
        ...
        srvServerKey = new com.mindbright.jce.provider.publickey.RSAPublicKey(n, e);

        pdu.readInt();
        e = pdu.readBigInteger();
        n = pdu.readBigInteger();
        srvHostKey = new com.mindbright.jce.provider.publickey.RSAPublicKey(n, e);
        ...
        if (SSH.DEBUGMORE) {
            ...
            SSH.logDebug(" ciphers:    " + c);
            SSH.logDebug(" auth types: " + a);
        }
    }
